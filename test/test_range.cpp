...
int main()
{
  ...
  if (r != Range<unsigned int>(0, 6))
    return 1;
  r = r1; r.expandWith(r5); cout << "r1 \\/ r5: "  << r.toString() << endl;
  if (r != Range<unsigned int>(3, 25))
    return 1;
  ...
  if (r != Range<unsigned int>(4, 7))
    return 1;
  r = r1 + 2; cout << "r1 + 2: " << r.toString() << endl;
  if (r != Range<unsigned int>(5, 8))
    return 1;
  r = r1; r -= 1; cout << "r1 -= 1: " << r.toString() << endl;
  if (r != Range<unsigned int>(2, 5))
    return 1;
  r = r1 - 2; cout << "r1 - 2: " << r.toString() << endl;
  if (r != Range<unsigned int>(1, 4))
    return 1;
