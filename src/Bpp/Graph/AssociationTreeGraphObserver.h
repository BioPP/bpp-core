...
// interface
  ...
  template<class N, class E, class TreeGraphImpl>
  bool SimpleAssociationTreeGraphObserver<N, E, TreeGraphImpl>::hasFather(const SimpleAssociationTreeGraphObserver<N, E, TreeGraphImpl>::NodeIndex index) const
  {
  ...
  template<class N, class E, class TreeGraphImpl>
  std::shared_ptr<E>  SimpleAssociationTreeGraphObserver<N, E, TreeGraphImpl>::getEdgeToFather(const SimpleAssociationTreeGraphObserver<N, E, TreeGraphImpl>::NodeIndex index) const
  {
  ...
  template<class N, class E, class TreeGraphImpl>
  std::vector<std::shared_ptr<N> > SimpleAssociationTreeGraphObserver<N, E, TreeGraphImpl>::getLeavesUnderNode(const std::shared_ptr<N> node) const
  {
