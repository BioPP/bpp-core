...
void PgfGraphicDevice::setCurrentLineType(short type)
{
  ...
  else if (type == LINE_DOTTED)
  {
    ...
    throw Exception("PgfGraphicDevice::setCurrentLineType. Unknown line type: " + TextTools::toString(type));
}
...
void PgfGraphicDevice::drawText(double x, double y, const std::string& text, short hpos, short vpos, double angle)
{
  ...
  if (vpos == TEXT_VERTICAL_BOTTOM)
    ...
    throw UnvalidFlagException("PgfGraphicDevice::drawText. Invalid vertical alignment option.");
  if (hpos == TEXT_HORIZONTAL_LEFT)
    ...
    throw UnvalidFlagException("PgfGraphicDevice::drawText. Invalid horizontal alignment option.");
